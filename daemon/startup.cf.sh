...
RECOVERY="php -d error_log=/www/netkiller.cn/inf.netkiller.cn/log/php_errors.log -c /srv/php/etc/php-cli.ini /www/netkiller.cn/inf.netkiller.cn/daemon/synchronous.cf.php restart"
